...
student = (name = "Jayanth PSY", kerberos_id = "NA")
...
ex_1_1 = md"""
Let √x = b. 
Without loss of generality, x/a < a. 
if a < b, a*a < b*b == x ⟺ a*a < x. But as x/a < a, x < a*a. Hence a contradiction.
if b < x/a, x == b*b < x*x / (a*a) ⟺ x < x*x /(a*a) ⟺ a*a < x. But as x/a < a, x < a*a. Hence a contradiction.
...
function newton_sqrt(x, error_margin=0.01, a=x / 2) # a=x/2 is the default value of `a`
	...
	return newton_sqrt(x, error_margin, (a + x/a)/2)
end
